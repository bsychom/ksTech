  ...
  return (
    <div className="w-screen h-screen bg-white relative overflow-x-hidden">
      ...
      <div className="relative w-full h-full ">
        ...
        <Hero/>
        {/* bg-[#001F3F]/20 */}
        <div className="pt-10 w-full relative container mx-auto">
