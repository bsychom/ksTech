...
export default function Hero(){
    return (
        ...
        <div className="lg:w-1/2 pt-6 md:px-6 lg:px-0 2xl:w-[1000px]   h-full  flex justify-center items-center ">
          <div className="w-full   lg:w-[70%]  bg-black/70 py-6  px-2 md:p-10 2xl:p-14 md:rounded-lg 2xl:rounded-xl">
